# -*- coding: utf-8 -*-
"""Insurance_Claim_Model_API

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KCtoY97DFCrtXcVxn1-fKF11bKxcvDiq
"""

# Importing main Flask Class and request
...
def load_model():
    ...
    # Loading the columns to drop file
    columns_to_drop=pd.read_csv("/model/columns_to_drop.csv")

    # Selecting the columns to be retained
    ...
    # Reading the label encoders and applying the encoded values to the categorical variables
    for cf1 in categorical_columns:
        filename = "/model/"+cf1+".sav"
        le = pickle.load(open(filename, 'rb'))

        # If a new classes is observed, set it to the 0 class
...
# Runing app in debug mode on port 4000
